      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-bg-secondary rounded-3xl p-8 border border-border">
            <h3 className="text-2xl font-bold text-roya-primary mb-6">{t("marketing.title")}</h3>
            <ul className="space-y-4">
              {t.raw("marketing.list").map((service: string, index: number) => (
          ...
          <div className="bg-white rounded-3xl p-8 border-2 border-roya-accent/20 relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-roya-primary mb-6">{t("software.title")}</h3>
            <ul className="space-y-4">
              {t.raw("software.list").map((service: string, index: number) => (
                <li key={index} className="flex items-center gap-3 text-text-secondary">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none select-none">
          ...
          />
            ...
            <h3 className="text-2xl font-bold mb-6">{t("growth.title")}</h3>
            <ul className="space-y-4">
              {t.raw("growth.list").map((service: string, index: number) => (
