  ...
  return (
    <section className="py-24 bg-gradient-to-br from-roya-primary/5 via-bg-secondary to-roya-accent/5">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <h2 className="text-4xl md:text-6xl font-bold text-roya-primary mb-6">Your next growth story starts here.</h2>
        <p className="text-xl text-text-secondary mb-12">
          Let's build a marketing strategy and digital experience that drives measurable business results.
        </p>
