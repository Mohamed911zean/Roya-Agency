...
import { ArrowRight, Layers, Star, TrendingUp, BarChart3, PieChart } from "lucide-react"
    ...
    <section className="relative min-h-screen pt-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-32 flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1 space-y-8">
          ...
          >
            {["Marketing Strategy", "Branding", "Paid Advertising", "Growth Systems"].map((tag, idx) => (
              <span 
                key={tag}
        ...
        >
          <div className="bg-white rounded-3xl shadow-2xl border border-border p-8">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-3xl font-bold text-roya-primary">+124%</p>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-bg-secondary rounded-2xl p-6">
                ...
                <div className="h-3 bg-border rounded-full overflow-hidden">
                  <div className="h-full w-3/4 bg-gradient-to-r from-roya-primary to-roya-accent" />
                </div>
              </div>
          ...
          <motion.div 
            ...
            className="absolute -top-8 -left-8 bg-white p-4 rounded-2xl shadow-xl border border-border"
          >
          ...
          <motion.div 
            ...
            className="absolute -bottom-8 -right-8 bg-white p-4 rounded-2xl shadow-xl border border-border"
          >
